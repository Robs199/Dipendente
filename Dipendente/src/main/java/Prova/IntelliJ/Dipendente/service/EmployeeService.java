...
@Service
    ...
    public class EmployeeService {
        ...
        public void insertEmployee(Employee employee) throws MyException {
            ...
            if(employee.getName()==null||employee.getSurname()==null||employee.getAge()==null||employee.getCF()==null||employee.getQualification()==null||
        ...
        public void updateEmployee(String codiceFiscale, Employee employee) throws CFException{
            ...
            if(employeeRepository.existsBycF(codiceFiscale)) {
                ...
                throw  new CFException("Codice fiscale non trovato");
            }
            }else{
        ...
        public void deleteEmployee(String cF) throws CFException {
            if(employeeRepository.existsBycF(cF)){
             Employee employee= employeeRepository.findBycF(cF);
                employeeRepository.delete(employee);
            }else{
                 throw new CFException("Codice fiscale non trovato nel database");
            }
        }
        ...
        public Employee findOne(String cF) throws CFException{
            if(employeeRepository.existsBycF(cF)){
